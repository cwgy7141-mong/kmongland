    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Modal */}
          <motion.div
            className="relative w-[90%] max-w-[400px] bg-[#0a0a0a] border border-white/10 rounded-2xl p-8 sm:p-10 shadow-2xl"
          ...
          >
            ...
            {/* Header */}
            <h2 className="text-white text-[24px] font-semibold tracking-[-0.02em] mb-2">
              Sign In
            </h2>
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="w-full h-[52px] rounded-xl bg-white/[0.07] border border-white/10 text-white text-[14px] font-semibold flex items-center justify-center gap-3 hover:bg-white/[0.12] active:scale-[0.98] transition-all cursor-pointer"
              >
